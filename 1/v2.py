...
class v2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "v2")
        ...
        self.iio_pluto_source_0.set_frequency(103200000)
...
def main(top_block_cls=v2, options=None):
